...
1. Users may only conduct queries or submit updates of a nature, rate or volume permitted by the [Acceptable Use Policy](23.RIPE-Database-Acceptable-Use-Policy.md#ripe-database-acceptable-use-policy).
