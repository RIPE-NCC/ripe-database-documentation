...
|-------------|-----------------------------------------------------------------------------------------------------------|
| TEST        | http://rest-test.db.ripe.net </br> https://rest-test.db.ripe.net </br> https://rest-cert-test.db.ripe.net |
| PROD        | http://rest.db.ripe.net </br> https://rest.db.ripe.net </br> https://rest-cert.db.ripe.net                |
...
[Client Certificate Authenticate](https://developer.mozilla.org/en-US/docs/Web/HTTP/Authentication#Client_certificate_authentication)
is supported by our REST API. To use our certificated endpoint, it is required to create a certificate either by
certificate authority (CA) or generated by the user performing the request.
...
- Create your own certificate:
  ...
  - Generate the self-signed certificate using the CRS: openssl x509 -req -days 365 -in client.csr -signkey client.key -out client.crt
  - Example using curl and previous certificate: 
    - curl --cert client.crt --key client.key -X PUT --data @form.txt'https://rest.db.ripe.net/ripe/person/TP1-RIPE?dry-run&password=...'