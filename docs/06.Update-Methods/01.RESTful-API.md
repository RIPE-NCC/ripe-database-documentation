...
| name          | description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Authorization | [Basic HTTP Authentication](https://datatracker.ietf.org/doc/html/rfc7617). The Authorisation request header can be used for API key authentication. <br/>To use API key authentication, the value contains a Base64-encoded value displayed when the API key was created. |
...
| Authentication failure (401) | Incorrect or no credential supplied.                                                             |
...
* Example XML Request:
  ...
  ```
  curl -X POST -H 'Content-Type: application/xml' --data @form.txt 'https://rest.db.ripe.net/ripe/person'
  ```

* Example JSON Request:
  ```
  curl -X POST -H 'Content-Type: application/json' -H 'Accept: application/json' --data @form.txt 'https://rest.db.ripe.net/ripe/person'
  ```
...
* Example dry-run requests:
  ``` 
  curl -X POST --data @form.txt 'https://rest.db.ripe.net/ripe/person?dry-run'
  
  curl -X POST --data @form.txt 'https://rest.db.ripe.net/ripe/person?dry-run=true'
  ```
...
* Example XML Request:
  ```
  curl -X PUT -H 'Content-Type: application/xml' --data @form.txt 'https://rest.db.ripe.net/ripe/person/PP1-RIPE'
  ```
 
* Example JSON Request:
  ```
  curl -X PUT -H 'Content-Type: application/json' -H 'Accept:application/json' --data @form.txt 'https://rest.db.ripe.net/ripe/person/PP1-RIPE'
  ```

* Example of a bad XML request when updating a mntner object using as request the person object from the first example:
  ```
  curl -X PUT -H 'Content-Type: application/xml' --data @form.txt 'https://rest.db.ripe.net/ripe/mntner/PP1-RIPE'
  ```
...
* Example dry-run requests:
  ``` 
  curl -X PUT --data @form.txt 'https://rest.db.ripe.net/ripe/person/TP1-RIPE?dry-run'

  curl -X PUT --data @form.txt 'https://rest.db.ripe.net/ripe/person/TP1-RIPE?dry-run=true'
  ```
...
* Example Request:
  ```
  curl -X DELETE -H 'Authorization: Basic QUExLVRFU1Q6QUExLVRFU1QtUEFTU1dPUkQ=' 'https://rest.db.ripe.net/ripe/person/pp1-ripe' 
  ```
...
* Example dry-run requests:
  ```
  curl -X PUT --data @form.txt -H 'Authorization: Basic QUExLVRFU1Q6QUExLVRFU1QtUEFTU1dPUkQ=' 'https://rest.db.ripe.net/ripe/person/TP1-RIPE?dry-run'
  
  curl -X PUT --data @form.txt -H 'Authorization: Basic QUExLVRFU1Q6QUExLVRFU1QtUEFTU1dPUkQ=' 'https://rest.db.ripe.net/ripe/person/TP1-RIPE?dry-run=true'
  ```
