...
allocation and build a copy of your network you can do this in the TEST Database. PGPKEY-2B4DEF0D is a well-known PGP 
key with the private key in remarks: attributes that allow you to sign your updates without the need to use your 
SSO account.
