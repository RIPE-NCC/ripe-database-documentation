...
### Step 3b: Create your domain objects using Syncupdates, email or the REST API

If you choose to create **domain** objects using Syncupdates, email or the REST API, you will first need to chop your address block into "chunks" that can be delegated. For example, if you have been allocated 10.155.16/22, you need to create four reverse zones:
