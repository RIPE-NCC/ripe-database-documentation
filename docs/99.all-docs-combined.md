...
<div id="section-introduction-to-the-ripe-database-01-ripe-database-documentation-overview" class="section-title">01 RIPE Database Documentation Overview</div>

<a id="section-introduction-to-the-ripe-database-01-ripe-database-documentation-overview--ripe-database-documentation-overview"></a>
...
<div id="section-introduction-to-the-ripe-database-02-intended-audience" class="section-title">02 Intended Audience</div>

<a id="section-introduction-to-the-ripe-database-02-intended-audience--intended-audience"></a>
# Intended Audience
...
<div id="section-introduction-to-the-ripe-database-03-conventions-used-in-the-ripe-database-documentation" class="section-title">03 Conventions Used in the RIPE Database Documentation</div>

<a id="section-introduction-to-the-ripe-database-03-conventions-used-in-the-ripe-database-documentation--conventions-used-in-the-ripe-database-documentation"></a>
...
<div id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database" class="section-title">01 Purpose and Content of the RIPE Database</div>

<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--purpose-and-content-of-the-ripe-database"></a>
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--purpose-of-the-ripe-database"></a>
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--ripe-internet-number-registry"></a>
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--the-ripe-internet-routing-registry"></a>
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--reverse-delegation"></a>
## Reverse Delegation

<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--what-is-reverse-delegation"></a>
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--reverse-delegation-in-the-ripe-database"></a>
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--domain-names"></a>
## Domain Names
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--administration-of-internet-resources"></a>
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--mirrored-databases"></a>
## Mirrored Databases
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--criteria-for-a-mirrored-database"></a>
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--i-want-to-change-something-in-the-ripe-database"></a>
...
<a id="section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--terms-and-conditions"></a>
...
<div id="section-what-is-the-ripe-database-02-history-of-the-ripe-database" class="section-title">02 History of the RIPE Database</div>

<a id="section-what-is-the-ripe-database-02-history-of-the-ripe-database--history-of-the-ripe-database"></a>
# History of the RIPE Database


* [Background of the RIPE Database](#section-what-is-the-ripe-database-02-history-of-the-ripe-database--background-of-the-ripe-database)
* [Versions of the RIPE Database](#section-what-is-the-ripe-database-02-history-of-the-ripe-database--versions-of-the-ripe-database)


<a id="section-what-is-the-ripe-database-02-history-of-the-ripe-database--background-of-the-ripe-database"></a>
...
<a id="section-what-is-the-ripe-database-02-history-of-the-ripe-database--versions-of-the-ripe-database"></a>
...
<div id="section-what-is-the-ripe-database-03-personal-data-database-management-and-reponsabilities" class="section-title">03 Personal Data Database Management and Reponsabilities</div>

<a id="section-what-is-the-ripe-database-03-personal-data-database-management-and-reponsabilities--personal-data-database-management-and-responsibilities"></a>
# Personal Data, Database Management and Responsibilities

* [Personal Data in the RIPE Database](#section-what-is-the-ripe-database-03-personal-data-database-management-and-reponsabilities--personal-data-in-the-ripe-database)
* [Database Management](#section-what-is-the-ripe-database-03-personal-data-database-management-and-reponsabilities--database-management)
* [Responsibilities of the RIPE NCC and Data Maintainers](#section-what-is-the-ripe-database-03-personal-data-database-management-and-reponsabilities--responsibilities-of-the-ripe-ncc-and-data-maintainers)


<a id="section-what-is-the-ripe-database-03-personal-data-database-management-and-reponsabilities--personal-data-in-the-ripe-database"></a>
...
<a id="section-what-is-the-ripe-database-03-personal-data-database-management-and-reponsabilities--database-management"></a>
## Database Management
...
<a id="section-what-is-the-ripe-database-03-personal-data-database-management-and-reponsabilities--responsibilities-of-the-ripe-ncc-and-data-maintainers"></a>
...
<div id="section-ripe-database-structure-01-database-object" class="section-title">01 Database Object</div>

<a id="section-ripe-database-structure-01-database-object--database-objects"></a>
# Database Objects
...
<div id="section-ripe-database-structure-02-primary-and-secondary-objects" class="section-title">02 Primary and Secondary Objects</div>

<a id="section-ripe-database-structure-02-primary-and-secondary-objects--primary-and-secondary-objects"></a>
...
<div id="section-ripe-database-structure-03-list-of-primary-objects" class="section-title">03 List of Primary Objects</div>

<a id="section-ripe-database-structure-03-list-of-primary-objects--list-of-primary-objects"></a>
...
<div id="section-ripe-database-structure-04-list-of-secondary-objects" class="section-title">04 List of Secondary Objects</div>

<a id="section-ripe-database-structure-04-list-of-secondary-objects--list-of-secondary-objects"></a>
...
<div id="section-ripe-database-structure-05-the-attributes-in-database-objects" class="section-title">05 The Attributes in Database Objects</div>

<a id="section-ripe-database-structure-05-the-attributes-in-database-objects--the-attributes-in-database-objects"></a>
...
<div id="section-ripe-database-structure-06-attribute-names" class="section-title">06 Attribute Names</div>

<a id="section-ripe-database-structure-06-attribute-names--attribute-names"></a>
# Attribute Names
...
<div id="section-ripe-database-structure-07-attributes-in-an-object" class="section-title">07 Attributes in an Object</div>

<a id="section-ripe-database-structure-07-attributes-in-an-object--attributes-in-an-object"></a>
# Attributes in an Object

The first attribute must have the same name as the object type. This identifies the object type. The currently available object types are shown in the sub-sections, ['List of Primary Objects'](#section-ripe-database-structure-03-list-of-primary-objects--list-of-primary-objects) and ['List of Secondary Objects'](#section-ripe-database-structure-04-list-of-secondary-objects--list-of-secondary-objects). If the type is not recognised, that part of an update message will be seen as a paragraph of text and will be disregarded with an appropriate error message. If the unrecognised type is in a query, it will be rejected with an error.
...
<a id="section-ripe-database-structure-08-attribute-values--split-values"></a>
## Split Values
...
<a id="section-ripe-database-structure-08-attribute-values--end-of-line-comments"></a>
...
<a id="section-ripe-database-structure-08-attribute-values--list-values"></a>
## List Values

Some attributes allow the value to be a list. This must be a comma-separated list with no spaces allowed. These attributes can be viewed in the [Appendix](#section-appendices-01-appendix-a--syntax-of-object-attributes--appendix-a-syntax-of-object-attributes).
...
<div id="section-ripe-database-structure-09-attribute-properties" class="section-title">09 Attribute Properties</div>

<a id="section-ripe-database-structure-09-attribute-properties--attribute-properties"></a>
...
<a id="section-ripe-database-structure-09-attribute-properties--presence"></a>
## Presence
...
<a id="section-ripe-database-structure-09-attribute-properties--repeat"></a>
## Repeat
...
<a id="section-ripe-database-structure-09-attribute-properties--indexed"></a>
## Indexed
...
<div id="section-ripe-database-structure-10-how-to-organise-your-data" class="section-title">10 How to Organise Your Data</div>

<a id="section-ripe-database-structure-10-how-to-organise-your-data--how-to-organize-your-data"></a>
...
The RIPE Database is intended for those who have, or will soon have Internet resources. This database is a public registry with a well-defined purpose. See ['Purpose of the RIPE Database'](#section-what-is-the-ripe-database-01-purpose-and-content-of-the-ripe-database--purpose-of-the-ripe-database) for more details. You can create many objects in the RIPE Database without any resources. But if these objects are not referenced by any resource object within a specified time period they will all be deleted. See the section on [Garbage Collection](#section-updating-objects-in-the-ripe-database-07-garbage-collection--garbage-collection) for more details.
...
<a id="section-ripe-database-structure-10-how-to-organise-your-data--using-the-organisation-object"></a>
...
<a id="section-ripe-database-structure-10-how-to-organise-your-data--using-the-role-object"></a>
...
<a id="section-ripe-database-structure-10-how-to-organise-your-data--abuse-details"></a>
## Abuse Details
...
<a id="section-ripe-database-structure-10-how-to-organise-your-data--who-maintains-the-data"></a>
...
<a id="section-ripe-database-structure-10-how-to-organise-your-data--how-do-i-keep-an-audit-trail-of-changes-to-my-data"></a>
...
<div id="section-ripe-database-structure-11-rest-api-data-model" class="section-title">11 REST API Data model</div>

<a id="section-ripe-database-structure-11-rest-api-data-model--rest-api-data-model"></a>
# REST API Data model

<a id="section-ripe-database-structure-11-rest-api-data-model--whoisresources"></a>
## WhoisResources

<a id="section-ripe-database-structure-11-rest-api-data-model--description"></a>
### Description
...
<a id="section-ripe-database-structure-11-rest-api-data-model--xml"></a>
#### XML 
...
<a id="section-ripe-database-structure-11-rest-api-data-model--json-structure"></a>
#### JSON structure
...
<a id="section-ripe-database-structure-11-rest-api-data-model--textplain"></a>
### Text/Plain
...
<a id="section-ripe-database-structure-11-rest-api-data-model--elements"></a>
### Elements

* [link](#section-ripe-database-structure-11-rest-api-data-model--link)
* [parameters](#section-ripe-database-structure-11-rest-api-data-model--parameters)
* [objects](#section-ripe-database-structure-11-rest-api-data-model--objects) 
* [object](#section-ripe-database-structure-11-rest-api-data-model--object) 
* [tags](#section-ripe-database-structure-11-rest-api-data-model--tags)
* [geolocation-attributes](#section-ripe-database-structure-11-rest-api-data-model--geolocation-attributes)
* [sources](#section-ripe-database-structure-11-rest-api-data-model--sources) 
* [errorMessages](#section-ripe-database-structure-11-rest-api-data-model--error-messages) 
* [versions](#section-ripe-database-structure-11-rest-api-data-model--versions) 


***


<a id="section-ripe-database-structure-11-rest-api-data-model--link"></a>
#### Link: 
...
<a id="section-ripe-database-structure-11-rest-api-data-model--parameters"></a>
#### Parameters: 
...
<a id="section-ripe-database-structure-11-rest-api-data-model--objects"></a>
#### Objects: 
...
<a id="section-ripe-database-structure-11-rest-api-data-model--object"></a>
#### Object: 
Representation of a RPSL object. Contained within [Objects](#section-ripe-database-structure-11-rest-api-data-model--objects).
...
<a id="section-ripe-database-structure-11-rest-api-data-model--tags"></a>
#### Tags: 
Set of _tag_
...
<a id="section-ripe-database-structure-11-rest-api-data-model--geolocation-attributes"></a>
#### Geolocation-attributes: 
...
<a id="section-ripe-database-structure-11-rest-api-data-model--sources"></a>
#### Sources: 
...
<a id="section-ripe-database-structure-11-rest-api-data-model--grs-sources"></a>
#### Grs-sources: 
...
<a id="section-ripe-database-structure-11-rest-api-data-model--versions"></a>
#### Versions: 
Enumeration of the changes of a particular object. Will only be in the [versions](#section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-versions) response payload. Consists of _type_ (see Type), _key_ (see Primary key) and _version_.
...
<a id="section-ripe-database-structure-11-rest-api-data-model--error-messages"></a>
#### Error messages: 
...
<a id="section-ripe-database-structure-11-rest-api-data-model--data-types"></a>
### Data Types
...
<a id="section-ripe-database-structure-11-rest-api-data-model--template-resources"></a>
## Template Resources
...
<a id="section-ripe-database-structure-11-rest-api-data-model--json"></a>
#### JSON
...
<div id="section-rpsl-object-types-01-description-of-attributes-common-to-all-objects" class="section-title">01 Description of Attributes Common to all Objects</div>

<a id="section-rpsl-object-types-01-description-of-attributes-common-to-all-objects--description-of-attributes-common-to-all-objects"></a>
...
The source may be appended with a software-generated end-of-line comment ‘# Filtered'. This is not part of the stored data. It may be generated when the object is displayed, depending on the query flags used. (Note that users cannot add end-of-line comments to a source attribute. Please see ['End of Line Comments'](#section-ripe-database-structure-08-attribute-values--end-of-line-comments) for more information.)
...
<div id="section-rpsl-object-types-02-descriptions-of-primary-objects" class="section-title">02 Descriptions of Primary Objects</div>

<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--descriptions-of-primary-objects"></a>
# Descriptions of Primary Objects

* [Description of the AUT-NUM Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-aut-num-object)
* [Description of the DOMAIN Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-domain-object)
* [Description of the INET6NUM Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-inet6num-object)
* [Description of the INETNUM Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-inetnum-object)
* [Description of the ROUTE Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-route-object)
* [Description of the ROUTE6 Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-route6-object)
* [Description of the AS-SET Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-as-set-object)
* [Description of the FILTER-SET Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-filter-set-object)
* [Description of the INET-RTR Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-inet-rtr-object)
* [Description of the PEERING-SET Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-peering-set-object)
* [Description of the ROUTE-SET Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-route-set-object)
* [Description of the RTR-SET Object](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-rtr-set-object)


<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-aut-num-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-domain-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-inet6num-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-inetnum-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-route-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-route6-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-as-set-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-filter-set-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-inet-rtr-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-peering-set-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-route-set-object"></a>
...
<a id="section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-rtr-set-object"></a>
...
<div id="section-rpsl-object-types-03-descriptions-of-secondary-objects" class="section-title">03 Descriptions of Secondary Objects</div>

<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--descriptions-of-secondary-objects"></a>
# Descriptions of Secondary Objects

* [Description of the AS-BLOCK Object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-as-block-object)
* [Description of the IRT Object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-irt-object)
* [Description of the KEY-CERT Object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-key-cert-object)
* [Description of the MNTNER Object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-mntner-object)
* [Description of the ORGANISATION Object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-organisation-object)
* [Description of the PERSON Object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-person-object)
* [Description of the POEM Object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-poem-object)
* [Description of the POETIC-FORM Object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-poetic-form-object)
* [Description of the ROLE Object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-role-object)


<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-as-block-object"></a>
...
<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-irt-object"></a>
...
<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-key-cert-object"></a>
...
If you want to create an X.509 **key-cert** object you must follow this [appendix](#section-appendices-09-appendix-i--client-certificate-authentication--appendix-i-client-certificate-authentication).
...
In case of performing REST updates using this authentication method [Client Certificate Authentication](#section-update-methods-01-restful-api--client-certificate-authentication) API needs to be used. 
...
<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-mntner-object"></a>
...
<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-organisation-object"></a>
...
<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-person-object"></a>
...
<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-poem-object"></a>
...
<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-poetic-form-object"></a>
...
<a id="section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-role-object"></a>
...
<div id="section-available-databases-01-ripe-database" class="section-title">01 RIPE Database</div>

<a id="section-available-databases-01-ripe-database--ripe-database"></a>
# RIPE Database
...
<div id="section-available-databases-02-test-database" class="section-title">02 TEST Database</div>

<a id="section-available-databases-02-test-database--test-database"></a>
# TEST Database
...
<div id="section-available-databases-03-release-candidate-database" class="section-title">03 Release Candidate Database</div>

<a id="section-available-databases-03-release-candidate-database--release-candidate-database-rc"></a>
...
<div id="section-available-databases-04-experimental-databases" class="section-title">04 Experimental Databases</div>

<a id="section-available-databases-04-experimental-databases--experimental-databases"></a>
...
<div id="section-update-methods-01-restful-api" class="section-title">01 RESTful API</div>

<a id="section-update-methods-01-restful-api--ripe-database-restful-api"></a>
...
<a id="section-update-methods-01-restful-api--restful-uri-format"></a>
## RESTful URI format
...
<a id="section-update-methods-01-restful-api--environments"></a>
### Environments
...
<a id="section-update-methods-01-restful-api--post"></a>
### POST
...
<a id="section-update-methods-01-restful-api--method-post"></a>
#### METHOD: POST
<a id="section-update-methods-01-restful-api--uri-format-sourceobjecttype"></a>
#### URI Format: /{source}/{objectType}
<a id="section-update-methods-01-restful-api--path-parameters"></a>
#### Path Parameters
| name       | description                          |
|------------|--------------------------------------|
...
<a id="section-update-methods-01-restful-api--query-parameters"></a>
#### Query Parameters
| name        | description                                                                             |
|-------------|-----------------------------------------------------------------------------------------|
...
<a id="section-update-methods-01-restful-api--headers"></a>
### Headers
| name          | description                                                                                                                                                                                                                   |
|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
<a id="section-update-methods-01-restful-api--http-request-body"></a>
#### HTTP Request Body

A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--rest-api-data-model) containing the object to be created.
...
<a id="section-update-methods-01-restful-api--http-response-body"></a>
#### HTTP Response Body

A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--rest-api-data-model) containing the newly created, unfiltered object.


<a id="section-update-methods-01-restful-api--http-status-codes"></a>
#### HTTP Status Codes
...
<a id="section-update-methods-01-restful-api--examples"></a>
#### Examples
...
<a id="section-update-methods-01-restful-api--put"></a>
### PUT
...
<a id="section-update-methods-01-restful-api--method-put"></a>
#### Method: PUT

<a id="section-update-methods-01-restful-api--uri-format-sourceobjecttypekey"></a>
...
<a id="section-update-methods-01-restful-api--http-request-body"></a>
#### HTTP Request Body
A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--rest-api-data-model) containing the new version of the specified objects.
...
<a id="section-update-methods-01-restful-api--http-response-body"></a>
#### HTTP Response Body
A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--rest-api-data-model) containing either the newly created, unfiltered object or the error message in case of a bad/unauthorized request.
...
<a id="section-update-methods-01-restful-api--error-response"></a>
#### Error Response

If the request fails, any error messages will be returned in the response body, using the request Accept format (XML or JSON). This element will not be included on a successful response. Examples in [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--rest-api-data-model).
...
<a id="section-update-methods-01-restful-api--delete"></a>
### DELETE
...
<a id="section-update-methods-01-restful-api--method-delete"></a>
#### Method: DELETE
...
<a id="section-update-methods-01-restful-api--http-response-body"></a>
#### HTTP Response Body
A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--rest-api-data-model) containing the (filtered) deleted object.
...
<a id="section-update-methods-01-restful-api--request-response-encoding"></a>
...
Any required passwords must also be supplied as part of the Uniform Resource identifier (URI) using the URI query parameter "password=". One parameter should be used for each password supplied. The pseudo attribute "password:" cannot be used in the HTTP request body. See ["Email Updates"](#section-update-methods-04-email-updates--email-updates) for more information.


<a id="section-update-methods-01-restful-api--client-certificate-authentication"></a>
...
<a id="section-update-methods-01-restful-api--example"></a>
### Example

For an example of how to use client certificate authentication, please see the appendix ["Client Certificate Authentication"](#section-appendices-09-appendix-i--client-certificate-authentication--introduction). 


<a id="section-update-methods-01-restful-api--api-key-authentication"></a>
...
For an example of how to use API keys, please see the appendix ["API Keys"](#section-appendices-11-appendix-k--api-keys--introduction).
...
<div id="section-update-methods-02-webupdates" class="section-title">02 Webupdates</div>

<a id="section-update-methods-02-webupdates--webupdates"></a>
# Webupdates
...
Any required passwords must also be supplied. These can be entered via the form password field. When using the text area input mode, passwords can also be included the message body using the "password:" attribute. More information about passwords is available in ['Email Updates'](#section-update-methods-04-email-updates--email-updates)


<a id="section-update-methods-02-webupdates--creating-basic-ripe-database-objects"></a>
...
<div id="section-update-methods-03-syncupdates" class="section-title">03 Syncupdates</div>

<a id="section-update-methods-03-syncupdates--syncupdates"></a>
# Syncupdates
...
To modify data without affecting the underlying database, you can use [dry-run](#section-updating-objects-in-the-ripe-database-08-dry-run--dry-run)
...
<div id="section-update-methods-04-email-updates" class="section-title">04 Email Updates</div>

<a id="section-update-methods-04-email-updates--email-updates"></a>
# Email Updates
...
Email update messages must be in plain text and can be MIME-encoded. If encoded messages are multipart/signed, the signature part will be associated with the corresponding MIME text part. When an encoded message is received, the database software will take each valid MIME part (including any related signature part) and merge them into one update message. Please see section ['MIME Support'](#section-update-methods-04-email-updates--mime-support) for more information.
...
<a id="section-update-methods-04-email-updates--mime-support"></a>
## MIME Support
...
<a id="section-update-methods-04-email-updates--subject-line-keywords"></a>
...
<div id="section-updating-objects-in-the-ripe-database-01-format-of-the-update-message" class="section-title">01 Format of the Update Message</div>

<a id="section-updating-objects-in-the-ripe-database-01-format-of-the-update-message--format-of-the-update-message"></a>
...
<div id="section-updating-objects-in-the-ripe-database-02-accessing-the-object-templates" class="section-title">02 Accessing the Object Templates</div>

<a id="section-updating-objects-in-the-ripe-database-02-accessing-the-object-templates--accessing-the-object-templates"></a>
...
<div id="section-updating-objects-in-the-ripe-database-03-object-processing" class="section-title">03 Object Processing</div>

<a id="section-updating-objects-in-the-ripe-database-03-object-processing--object-processing"></a>
# Object Processing
...
<div id="section-updating-objects-in-the-ripe-database-04-update-operations" class="section-title">04 Update Operations</div>

<a id="section-updating-objects-in-the-ripe-database-04-update-operations--update-operations"></a>
# Update Operations
...
flags to avoid any filtering of the returned object. See section on [Filtering Query Output](#section-types-of-queries-08-filtering-the-query-reponse--filtering-the-query-response) for more details.
...
<div id="section-updating-objects-in-the-ripe-database-06-special-considerations-for-object-creation" class="section-title">06 Special Considerations for Object Creation</div>

<a id="section-updating-objects-in-the-ripe-database-06-special-considerations-for-object-creation--special-considerations-for-object-creation"></a>
...
<a id="section-updating-objects-in-the-ripe-database-06-special-considerations-for-object-creation--creating-person-and-role-objects"></a>
...
If you are creating your first **person** or **role** object in the database, you must follow the procedure described in the sub-section ['New Organisation Startup'](#section-updating-objects-in-the-ripe-database-06-special-considerations-for-object-creation--new-organisation-startup).


<a id="section-updating-objects-in-the-ripe-database-06-special-considerations-for-object-creation--reusing-nic-handles"></a>
## Reusing NIC Handles
...
<a id="section-updating-objects-in-the-ripe-database-06-special-considerations-for-object-creation--creating-organisation-objects"></a>
...
<a id="section-updating-objects-in-the-ripe-database-06-special-considerations-for-object-creation--new-organisation-startup-creating-first-objects"></a>
...
<div id="section-updating-objects-in-the-ripe-database-07-garbage-collection" class="section-title">07 Garbage Collection</div>

<a id="section-updating-objects-in-the-ripe-database-07-garbage-collection--garbage-collection"></a>
# Garbage Collection
...
<div id="section-updating-objects-in-the-ripe-database-08-dry-run" class="section-title">08 Dry run</div>

<a id="section-updating-objects-in-the-ripe-database-08-dry-run--dry-run"></a>
# Dry-run
...
<div id="section-notifications-01-acknowledgment-message" class="section-title">01 Acknowledgment Message</div>

<a id="section-notifications-01-acknowledgment-message--acknowledgment-message"></a>
...
<a id="section-notifications-01-acknowledgment-message--email-acknowledgement-message"></a>
...
<a id="section-notifications-01-acknowledgment-message--syncupdates-acknowledgement-message"></a>
...
If you use Syncupdates via the web form (see the section ['Syncupdates'](#section-update-methods-03-syncupdates--syncupdates)) there is no response code. All information has to be interpreted using the content of the ack message.
...
<a id="section-notifications-01-acknowledgment-message--webupdates-acknowledgement-message"></a>
...
<a id="section-notifications-01-acknowledgment-message--restful-api-acknowledgement-message"></a>
...
<div id="section-notifications-02-notification-messages" class="section-title">02 Notification Messages</div>

<a id="section-notifications-02-notification-messages--notification-messages"></a>
...
<a id="section-notifications-02-notification-messages--notification-attributes"></a>
...
<a id="section-notifications-02-notification-messages--format-of-the-notification-message"></a>
...
<div id="section-authorisation-01-authorisation-model" class="section-title">01 Authorisation Model</div>

<a id="section-authorisation-01-authorisation-model--authorisation-model"></a>
# Authorisation Model
...
Visit [this section](#section-database-support-03-database-security--maintainers) to know more about **mntner** object.
...
<a id="section-authorisation-01-authorisation-model--solving-authentication-problems"></a>
...
<div id="section-authorisation-02-using-the-authorisation-methods" class="section-title">02 Using the Authorisation Methods</div>

<a id="section-authorisation-02-using-the-authorisation-methods--using-the-authorisation-methods"></a>
# Using the Authorisation Methods

* [MD5 Password](#section-authorisation-02-using-the-authorisation-methods--md5-password)
* [PGP Key](#section-authorisation-02-using-the-authorisation-methods--pgp-key)
* [X.509 Certificate](#section-authorisation-02-using-the-authorisation-methods--x-509-certificate)
* [Single Sign-On](#section-authorisation-02-using-the-authorisation-methods--single-sign-on)


<a id="section-authorisation-02-using-the-authorisation-methods--md5-password"></a>
## MD5 Password
...
With the RESTful API, any required passwords must be included in the URI query parameters. For more details see the [API documentation](#section-update-methods-01-restful-api--ripe-database-restful-api).


<a id="section-authorisation-02-using-the-authorisation-methods--pgp-key"></a>
## PGP Key

To use PGP authentication you must first create a private/public key pair. There are many third-party applications that will allow you to do this. You must keep the private key secure. The public key is entered into the RIPE Database in a **key-cert** object. (See ['Description of the key-cert Object'](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-key-cert-object) for details.)
...
PGP authentication creation steps are in the [appendix](#section-appendices-08-appendix-h--pgp-authentication-method--appendix-h-pgp-authentication-method).


<a id="section-authorisation-02-using-the-authorisation-methods--use-in-the-maintainer-object"></a>
...
<a id="section-authorisation-02-using-the-authorisation-methods--using-authentication-when-sending-updates"></a>
...
<a id="section-authorisation-02-using-the-authorisation-methods--x509-certificate"></a>
## X.509 Certificate
...
However, you can submit updates through the RESTful API using [Client Certificate Authentication](#section-appendices-09-appendix-i--client-certificate-authentication--appendix-i-client-certificate-authentication).
...
<a id="section-authorisation-02-using-the-authorisation-methods--single-sign-on"></a>
## Single Sign-On
...
<div id="section-authorisation-03-security-of-data-using-authorisation" class="section-title">03 Security of Data Using Authorisation</div>

<a id="section-authorisation-03-security-of-data-using-authorisation--security-of-data-using-authorisation"></a>
...
<div id="section-authorisation-04-protection-of-person-and-role-objects" class="section-title">04 Protection of PERSON and ROLE Objects</div>

<a id="section-authorisation-04-protection-of-person-and-role-objects--protection-of-person-and-role-objects"></a>
# Protection of PERSON and ROLE Objects

When "mnt-by:" was made mandatory on these objects a circular dependency was created. A **person** object must be maintained and a **mntner** must reference an existing **person**. Therefore, a new user who has no data in the RIPE Database must follow the procedure in the section, ['New Organisation Startup'](#section-updating-objects-in-the-ripe-database-06-special-considerations-for-object-creation--special-considerations-for-object-creation) to get started.
...
<div id="section-authorisation-05-protection-of-aut-num-object-space" class="section-title">05 Protection of AUT NUM Object Space</div>

<a id="section-authorisation-05-protection-of-aut-num-object-space--protection-of-aut-num-object-space"></a>
...
<div id="section-authorisation-06-protection-of-address-space" class="section-title">06 Protection of Address Space</div>

<a id="section-authorisation-06-protection-of-address-space--protection-of-address-space"></a>
...
<div id="section-authorisation-07-protection-of-route-object-space" class="section-title">07 Protection of Route Object Space</div>

<a id="section-authorisation-07-protection-of-route-object-space--protection-of-route6-object-space"></a>
...
<a id="section-authorisation-07-protection-of-route-object-space--authorisation-rules-for-creating-route-objects"></a>
...
When creating a **route(6)** object you must authenticate against multiple [maintainers](#section-database-support-03-database-security--maintainers) to verify that you have control over the address space you are referring to. This means the related **inet(6)num** object must exist in the RIPE Database and you can authenticate against it, before you can create a **route(6)** object in the IRR.
...
Here is a [flowchart outlining the entire authorisation process](#section-appendices-04-appendix-d--route-object-creation-flowchart--route-object-creation-flowchart).
...
If you wish to avoid having to supply multiple credentials, it is best to set up [hierarchical authorisation](#section-database-support-03-database-security--maintainers) by adding a "mnt-routes:" attribute to all of your resource objects and consistently use this maintainer to create and manage **route(6)** objects.


<a id="section-authorisation-07-protection-of-route-object-space--creating-route-objects-referring-to-resources-you-dont-manage"></a>
...
<a id="section-authorisation-07-protection-of-route-object-space--creating-route-objects-for-out-of-region-non-ripe-resources"></a>
...
<a id="section-authorisation-07-protection-of-route-object-space--force-deleting-blocking-route-objects"></a>
...
Normally an object can only be deleted if the operation is authorised by one of the maintainers in the "mnt-by:" attributes of the object to be deleted. However, the [force delete](#section-authorisation-14-force-delete-functionality--force-delete-functionality) functionality also looks for the exact matching, encompassing or less specific address space object that was co-maintained by the RIPE NCC in the hierarchy of the object that is to be deleted. Co-maintained objects include resources that were allocated or assigned by the RIPE NCC, and also legacy resources under contract.
...
<div id="section-authorisation-08-protection-of-reverse-delegation-objects" class="section-title">08 Protection of Reverse Delegation Objects</div>

<a id="section-authorisation-08-protection-of-reverse-delegation-objects--protection-of-reverse-delegation-objects"></a>
# Protection of Reverse Delegation Objects

Protection of the reverse domain object space for "in-addr.arpa" and "ip6.arpa" domains is done with separate methods for creation, deletion and modification. The **domain** object creation is described in a [flow chart](#section-appendices-05-appendix-e--domain-object-creation-flowchart--domain-object-creation-flowchart).
...
<div id="section-authorisation-09-protection-of-objects-with-hierarchical-names" class="section-title">09 Protection of Objects with Hierarchical Names</div>

<a id="section-authorisation-09-protection-of-objects-with-hierarchical-names--protection-of-objects-with-hierarchical-names"></a>
...
For set objects with non-hierarchical names, authorisation corresponds to the rules for individual objects described in the section ['Security of Data Using Authorisation'](#section-authorisation-03-security-of-data-using-authorisation--security-of-data-using-authorisation).
...
<div id="section-authorisation-10-protecting-membership-of-a-set" class="section-title">10 Protecting Membership of a Set</div>

<a id="section-authorisation-10-protecting-membership-of-a-set--protecting-membership-of-a-set"></a>
...
<div id="section-authorisation-11-referencing-an-organization-object" class="section-title">11 Referencing an ORGANIZATION Object</div>

<a id="section-authorisation-11-referencing-an-organization-object--referencing-an-organisation-object"></a>
...
<div id="section-authorisation-12-referencing-an-irt-object" class="section-title">12 Referencing an IRT Object</div>

<a id="section-authorisation-12-referencing-an-irt-object--referencing-an-irt-object"></a>
...
<div id="section-authorisation-13-irt-object" class="section-title">13 IRT Object</div>

<a id="section-authorisation-13-irt-object--irt-object"></a>
# IRT Object
...
<a id="section-authorisation-13-irt-object--how-to-create-an-irt-object"></a>
## How to Create an IRT Object
<a id="section-authorisation-13-irt-object--manual-creation"></a>
### Manual creation
<a id="section-authorisation-13-irt-object--requirements"></a>
#### Requirements
...
<a id="section-authorisation-13-irt-object--the-maintainer-mntner-object"></a>
...
<a id="section-authorisation-13-irt-object--the-pgp-key-and-the-key-cert-object"></a>
...
<a id="section-authorisation-13-irt-object--the-creation-process"></a>
...
<a id="section-authorisation-13-irt-object--creation-through-the-trusted-introducer-ti-service"></a>
...
<a id="section-authorisation-13-irt-object--how-to-link-inet6num-objects-to-an-irt-object"></a>
...
<a id="section-authorisation-13-irt-object--link-a-single-inet6num-object-to-an-irt-object"></a>
...
<a id="section-authorisation-13-irt-object--if-both-parties-use-different-pgp-keys-for-authorisation"></a>
...
<a id="section-authorisation-13-irt-object--if-only-one-party-uses-a-password-or-sso-for-authorisation"></a>
...
<a id="section-authorisation-13-irt-object--if-both-parties-use-password-or-sso-authorisation"></a>
...
<a id="section-authorisation-13-irt-object--if-the-irt-object-and-inet6num-object-are-maintained-by-the-same-maintainer"></a>
#### If the IRT Object and INET(6)NUM Object are Maintained by the Same Maintainer
In this case, the process is straightforward.


<a id="section-authorisation-13-irt-object--step-by-step-guide"></a>
### Step-by-Step Guide
...
<a id="section-authorisation-13-irt-object--link-more-than-one-inet6num-object-to-an-irt-object"></a>
## Link More Than One INET(6)NUM object to an IRT Object
<a id="section-authorisation-13-irt-object--all-inet6num-object-have-the-same-maintainer-object"></a>
...
<a id="section-authorisation-13-irt-object--some-inet6num-objects-have-different-maintainer-objects"></a>
...
<div id="section-authorisation-14-force-delete-functionality" class="section-title">14 Force Delete Functionality</div>

<a id="section-authorisation-14-force-delete-functionality--force-delete-functionality"></a>
...
<a id="section-authorisation-14-force-delete-functionality--authorisation-to-force-delete"></a>
...
<a id="section-authorisation-14-force-delete-functionality--example-of-force-delete"></a>
...
<a id="section-authorisation-14-force-delete-functionality--objects-that-can-be-force-deleted"></a>
...
<div id="section-authorisation-15-request-enum-delegation" class="section-title">15 Request ENUM delegation</div>

<a id="section-authorisation-15-request-enum-delegation--request-enum-delegation"></a>
...
<a id="section-authorisation-15-request-enum-delegation--requesting-secure-delegation-in-the-enum-domain"></a>
...
<a id="section-authorisation-15-request-enum-delegation--the-four-steps-to-updating-an-enum-delegation-to-have-a-secure-ds-record-in-e164arpa"></a>
...
1. Submitting the **domain** object
    ...
    1. By email
        You need to create a **domain** object containing information about the zone you need reverse delegation for. For further information go [here](#section-update-methods-04-email-updates--email-updates)
    ...
    1. Verifying the setup
        ...
        Any resolver which has the [DNSSEC](#section-authorisation-16-request-dnssec-delegation--dnssec-delegations) public key for e164.arpa configured should now return DNS answers which have the authenticated data bit set.

<a id="section-authorisation-15-request-enum-delegation--additional-notes"></a>
### Additional Notes
...
For further details on rolling keys and other important information on [DNSSEC](#section-authorisation-16-request-dnssec-delegation--dnssec-delegations) operational practices we recommend reading [RFC 4641](https://www.ietf.org/rfc/rfc4641.txt).
...
<div id="section-authorisation-16-request-dnssec-delegation" class="section-title">16 Request DNSSEC delegation</div>

<a id="section-authorisation-16-request-dnssec-delegation--dnssec-delegations"></a>
# DNSSEC Delegations
This procedure is in addition to the normal procedure for requesting reverse delegations.


<a id="section-authorisation-16-request-dnssec-delegation--the-domain-object"></a>
## The DOMAIN Object
...
To allow for the exchange of DNSSEC related information, the **domain** object now includes a ["ds-rdata:" attribute](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-domain-object). 


<a id="section-authorisation-16-request-dnssec-delegation--delegation-checks"></a>
## Delegation Checks
...
<div id="section-how-to-query-the-ripe-database-01-the-structure-of-a-query" class="section-title">01 The Structure of a Query</div>

<a id="section-how-to-query-the-ripe-database-01-the-structure-of-a-query--the-structure-of-a-query"></a>
...
<div id="section-how-to-query-the-ripe-database-02-web-query-form" class="section-title">02 Web Query Form</div>

<a id="section-how-to-query-the-ripe-database-02-web-query-form--web-query-form"></a>
# Web Query Form
...
<a id="section-how-to-query-the-ripe-database-02-web-query-form--using-full-text-search"></a>
...
<a id="section-how-to-query-the-ripe-database-02-web-query-form--uri-format-fulltextsearchselect"></a>
### URI Format: /fulltextsearch/select?...

<a id="section-how-to-query-the-ripe-database-02-web-query-form--query-parameters"></a>
### Query Parameters
...
<div id="section-how-to-query-the-ripe-database-03-restful-api-queries" class="section-title">03 RESTful API Queries</div>

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--restful-api-queries"></a>
# RESTful API Queries
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-lookup"></a>
## REST API Lookup
...
[Filtering the Query Response](#section-types-of-queries-08-filtering-the-query-reponse--filtering-the-query-response).
...
* [Version list](#section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-versions)
* [Version lookup](#section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-version)

***

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--method-get"></a>
### Method: GET

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-format-sourceobjecttypekey"></a>
### URI Format: /{source}/{objectType}/{key}

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--path-parameters"></a>
### Path Parameters
| name       | description                                    |
|------------|------------------------------------------------|
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--query-parameters"></a>
### Query Parameters
| name        | description                                                                                                                                                       |
|-------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| password    | Password for maintainer authentication (one or more values).                                                                                                      |
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--headers"></a>
### Headers
| name          | description                                                                                                                                                                                                                   |
|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Authorization | [Basic HTTP Authentication](https://datatracker.ietf.org/doc/html/rfc7617). The Authorisation request header value contains 'Basic' followed by the base64 encoding of the maintainer name and password separated by a colon. |

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--http-response-body"></a>
### HTTP Response Body

A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--whoisresources) containing the object.

By default the response object is filtered as described in 
[Filtering the Query Response](#section-types-of-queries-08-filtering-the-query-reponse--filtering-the-query-response). To return the unfiltered object specify the `unfiltered` query parameter. To obtain an unfiltered maintainer object (including all "auth:" attributes), the request must be authenticated.

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--http-status-codes"></a>
### HTTP status Codes
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--examples"></a>
### Examples
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-search"></a>
## REST API Search
...
[Filtering the Query Response](#section-types-of-queries-08-filtering-the-query-reponse--filtering-the-query-response). To return unfiltered objects specify the `flags` query parameter with the `B` or `no-filtering` flag value. To obtain an unfiltered maintainer object (including all "auth:" attributes), use the [REST API lookup](#section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-lookup).

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--locations"></a>
### Locations

[Environment endpoint](#section-update-methods-01-restful-api--environments)/search

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--http-method-get"></a>
### HTTP Method: GET

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-format-searchsourcesourcequery-stringquery-string"></a>
### URI Format: /search?source={source}&query-string={query-string}...

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-path-parameters"></a>
### URI Path Parameters

None.

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-query-parameters"></a>
...
A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--whoisresources) containing the query result.
...
Note that search response can be enormous. Hence, it is streamed on the server side, which means that if there is any error during processing your search, the HTTP response will still be 200. In this case, there will be the corresponding error messages inside the errormessages element in the response body (see [Whois Resources](#section-ripe-database-structure-11-rest-api-data-model--whoisresources)).
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-metadata"></a>
## REST API Metadata


<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--metadata-list-sources"></a>
...
[Environment endpoint](#section-update-methods-01-restful-api--environments)/metadata/sources

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--http-method-get"></a>
#### HTTP Method: GET

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-format-metadatasources"></a>
...
A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--whoisresources) containing all available sources.
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--metadata-object-template"></a>
### Metadata (Object Template)

Returns the RPSL template for given object type.

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--resources"></a>
#### Resources

[Environment endpoint](#section-update-methods-01-restful-api--environments)/metadata/templates

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--http-method-get"></a>
#### HTTP Method: GET

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-format-metadatatemplatesobjecttype"></a>
...
A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--whoisresources) containing the template of the specified type.
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-geolocation"></a>
...
[Environment endpoint](#section-update-methods-01-restful-api--environments)/geolocation

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--http-method-get"></a>
### HTTP Method: GET

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-format-geolocationipkeykey"></a>
...
A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--whoisresources) containing locator URIs to matching objects.
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-abuse-contact"></a>
...
[Environment endpoint](#section-update-methods-01-restful-api--environments)/abuse-contact

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--http-method-get"></a>
### HTTP Method: GET

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-format-abuse-contactresource"></a>
...
An [AbuseResources](#section-how-to-query-the-ripe-database-03-restful-api-queries--api-abuse-contact) containing locator URIs to matching objects.
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-version"></a>
## REST API Version
...
[Environment endpoint](#section-update-methods-01-restful-api--environments)

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--method-get"></a>
### Method: GET

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-format-sourceobjecttypekeyversionsversionnumber"></a>
### URI Format: /{source}/{objecttype}/{key}/versions/{versionnumber}

<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-parameters"></a>
### URI Parameters
| name          | description     |
|---------------|-----------------|
| source        | RIPE or TEST    |
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--response-body"></a>
### Response Body

A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--template-resources) containing the requested version of the object or the error message in case of Bad request (see [GET](#section-how-to-query-the-ripe-database-03-restful-api-queries--api-lookup)).


<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--status-codes"></a>
### Status Codes
| code | description                                  |
|------|----------------------------------------------|
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--rest-api-versions"></a>
## REST API Versions
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--uri-format-sourceobjecttypekeyversions"></a>
...
A [WhoisResource](#section-ripe-database-structure-11-rest-api-data-model--template-resources) containing information about updates for the requested object or the error message in case of Bad request (see [GET](#section-how-to-query-the-ripe-database-03-restful-api-queries--api-lookup)).
...
<a id="section-how-to-query-the-ripe-database-03-restful-api-queries--authentication"></a>
## Authentication
...
<div id="section-how-to-query-the-ripe-database-04-command-line-queries" class="section-title">04 Command Line Queries</div>

<a id="section-how-to-query-the-ripe-database-04-command-line-queries--command-line-queries"></a>
...
<a id="section-how-to-query-the-ripe-database-04-command-line-queries--netcat"></a>
## Netcat
...
<a id="section-how-to-query-the-ripe-database-04-command-line-queries--telnet"></a>
## Telnet
...
<a id="section-how-to-query-the-ripe-database-04-command-line-queries--whois-client"></a>
## Whois Client
...
<a id="section-how-to-query-the-ripe-database-04-command-line-queries--windows"></a>
### Windows
...
<a id="section-how-to-query-the-ripe-database-04-command-line-queries--linux"></a>
### Linux
...
<a id="section-how-to-query-the-ripe-database-04-command-line-queries--osx"></a>
### OSX
...
<div id="section-how-to-query-the-ripe-database-05-query-responses" class="section-title">05 Query Responses</div>

<a id="section-how-to-query-the-ripe-database-05-query-responses--query-responses"></a>
# Query Responses
...
* A message contains a white space after the % sign, while a server response code starts right after the % sign. See [Appendix C, RIPE Database Query Server Response Codes and Messages](#section-appendices-03-appendix-c--ripe-database-query-server-response-codes-and-messages--appendix-c--ripe-database-query-server-response-codes-and-messages) for more information. 
...
<div id="section-how-to-query-the-ripe-database-06-registration-data-access-protocol" class="section-title">06 Registration Data Access Protocol</div>

<a id="section-how-to-query-the-ripe-database-06-registration-data-access-protocol--registration-data-access-protocol-rdap"></a>
...
<a id="section-how-to-query-the-ripe-database-06-registration-data-access-protocol--using-rdap-to-query-the-ripe-database"></a>
...
<a id="section-how-to-query-the-ripe-database-06-registration-data-access-protocol--entity-search"></a>
## Entity Search
...
<a id="section-how-to-query-the-ripe-database-06-registration-data-access-protocol--domain-search"></a>
## Domain Search
...
<a id="section-how-to-query-the-ripe-database-06-registration-data-access-protocol--help"></a>
## Help
...
<a id="section-how-to-query-the-ripe-database-06-registration-data-access-protocol--rdap-specification"></a>
## RDAP Specification
...
<a id="section-how-to-query-the-ripe-database-06-registration-data-access-protocol--known-issues"></a>
## Known Issues
...
<div id="section-types-of-queries-02-queries-for-ip-networks" class="section-title">02 Queries for IP Networks</div>

<a id="section-types-of-queries-02-queries-for-ip-networks--queries-for-ip-networks"></a>
...
<a id="section-types-of-queries-02-queries-for-ip-networks--default-queries-for-ip-network"></a>
...
<a id="section-types-of-queries-02-queries-for-ip-networks--exact-match-queries"></a>
## Exact Match Queries
...
<a id="section-types-of-queries-02-queries-for-ip-networks--more-specific-range-queries"></a>
...
<a id="section-types-of-queries-02-queries-for-ip-networks--less-specific-range-queries"></a>
...
<a id="section-types-of-queries-02-queries-for-ip-networks--less-specific-range-queries-for-referenced-irt-objects"></a>
...
<div id="section-types-of-queries-03-queries-for-autonomous-systems" class="section-title">03 Queries for Autonomous Systems</div>

<a id="section-types-of-queries-03-queries-for-autonomous-systems--queries-for-autonomous-systems"></a>
...
<div id="section-types-of-queries-04-more-and-less-specific-lookups-for-reverse-domains" class="section-title">04 More and Less Specific Lookups For Reverse Domains</div>

<a id="section-types-of-queries-04-more-and-less-specific-lookups-for-reverse-domains--more-and-less-specific-lookups-for-reverse-domains"></a>
...
<div id="section-types-of-queries-05-inverse-queries" class="section-title">05 Inverse Queries</div>

<a id="section-types-of-queries-05-inverse-queries--inverse-queries"></a>
# Inverse Queries
...
<div id="section-types-of-queries-06-abuse-contacts" class="section-title">06 Abuse Contacts</div>

<a id="section-types-of-queries-06-abuse-contacts--abuse-contacts"></a>
# Abuse Contacts
...
<div id="section-types-of-queries-07-grouping-the-ripe-database-output" class="section-title">07 Grouping the RIPE Database Output</div>

<a id="section-types-of-queries-07-grouping-the-ripe-database-output--grouping-the-ripe-database-output"></a>
...
<div id="section-types-of-queries-08-filtering-the-query-reponse" class="section-title">08 Filtering the Query Reponse</div>

<a id="section-types-of-queries-08-filtering-the-query-reponse--filtering-the-query-response"></a>
...
<div id="section-types-of-queries-09-irr-toolset-support" class="section-title">09 IRR Toolset Support</div>

<a id="section-types-of-queries-09-irr-toolset-support--irr-toolset-support"></a>
# IRR Toolset Support
...
<div id="section-types-of-queries-10-persistent-connections-and-keeping-state" class="section-title">10 Persistent Connections and Keeping State</div>

<a id="section-types-of-queries-10-persistent-connections-and-keeping-state--persistent-connections-and-keeping-state"></a>
...
<div id="section-types-of-queries-11-getting-all-the-members-of-set-objects" class="section-title">11 Getting All the Members of Set objects</div>

<a id="section-types-of-queries-11-getting-all-the-members-of-set-objects--getting-all-the-members-of-set-objects"></a>
...
<div id="section-types-of-queries-12-access-control-for-queries" class="section-title">12 Access Control for Queries</div>

<a id="section-types-of-queries-12-access-control-for-queries--access-control-for-queries"></a>
...
Each time a **person** or **role** object is retrieved, a counter increases. When it reaches the limit defined in the [AUP](#section-ripe-database-acceptable-use-policy--ripe-database-acceptable-use-policy), the query execution is aborted and the connection is terminated, displaying an error message to the client (see "Access errors" in [Appendix C,RIPE Database Query Server Response Codes and Messages](#section-appendices-03-appendix-c--ripe-database-query-server-response-codes-and-messages--appendix-c--ripe-database-query-server-response-codes-and-messages)). Also a count of denials increases. Retrieving any other object type does not affect these counters.
...
<div id="section-types-of-queries-13-ripe-ncc-global-resource-service" class="section-title">13 RIPE NCC Global Resource Service</div>

<a id="section-types-of-queries-13-ripe-ncc-global-resource-service--ripe-ncc-global-resource-service"></a>
...
The mirrored databases are referenced by the source of the data. A list of currently available sources can be obtained by using [the “-q” query flag](#section-types-of-queries-14-other-query-flags--the--q-query-flag).
...
<div id="section-types-of-queries-14-other-query-flags" class="section-title">14 Other Query Flags</div>

<a id="section-types-of-queries-14-other-query-flags--other-query-flags"></a>
# Other Query Flags

* [The “-T” (“--select-types”) Query Flag](#section-types-of-queries-14-other-query-flags--the--t---select-types-query-flag)
* [The “-K” (“--primary-keys”) Query Flag](#section-types-of-queries-14-other-query-flags--the--k---primary-keys-query-flag)
* [The “-t” (“--template”) Query Flag](#section-types-of-queries-14-other-query-flags--the--t---template-query-flag)
* [The “-v” (“--verbose”) Query Flag](#section-types-of-queries-14-other-query-flags--the--v---verbose-query-flag)
* [The “-q” Query Flag](#section-types-of-queries-14-other-query-flags--the--q-query-flag)
* [The “-a” (“--all-sources”) Query Flag](#section-types-of-queries-14-other-query-flags--the--a---all-sources-query-flag)
* [The “-s” (“--sources”) Query Flag](#section-types-of-queries-14-other-query-flags--the--s---sources-query-flag)
* [The “-S“ (“--resources" Query Flag)](#section-types-of-queries-14-other-query-flags--the--s---resources-query-flag)
* [The “-F” (“--brief”) Query Flag](#section-types-of-queries-14-other-query-flags--the--f---brief-query-flag)
* [The “--valid-syntax” and “--no-valid-syntax” Query Flags](#section-types-of-queries-14-other-query-flags--the---valid-syntax-and---no-valid-syntax-query-flags)
* [The “-c” (“--irt”) Query Flag](#section-types-of-queries-14-other-query-flags--the--c---irt-query-flag)
* [The “-C” (“--no-irt”) Query Flag](#section-types-of-queries-14-other-query-flags--the--c---no-irt-query-flag)


<a id="section-types-of-queries-14-other-query-flags--the--t---select-types-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--k---primary-keys-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--t---template-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--v---verbose-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--q-query-flag"></a>
## The “-q” Query Flag
...
<a id="section-types-of-queries-14-other-query-flags--the--a---all-sources-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--s---sources-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--s---resources-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--f---brief-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the---valid-syntax-and---no-valid-syntax-query-flags"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--c---irt-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--c---no-irt-query-flag"></a>
...
<a id="section-types-of-queries-14-other-query-flags--the--z---charset-query-flag"></a>
...
<div id="section-types-of-queries-15-referenced-objects-in-query-response" class="section-title">15 Referenced Objects in Query Response</div>

<a id="section-types-of-queries-15-referenced-objects-in-query-response--referenced-objects-in-query-response"></a>
...
<div id="section-types-of-queries-16-historical-queries" class="section-title">16 Historical Queries</div>

<a id="section-types-of-queries-16-historical-queries--historical-queries"></a>
# Historical Queries
...
<div id="section-ripe-database-mirror-01-setup-ripe-database-mirror" class="section-title">01 Setup RIPE Database Mirror</div>

<a id="section-ripe-database-mirror-01-setup-ripe-database-mirror--setup-ripe-database-mirror"></a>
...
1. Using GRS import. 
    ...
    - First follow the whois [installation instructions](#section-installation-and-development-06-installation-instructions--installation-instructions), to have a working whois installation. 
...
2. Using Bootstrap and NRTMv3. 
    ...
    - First follow the whois [installation instructions](#section-installation-and-development-06-installation-instructions--installation-instructions) here, to have a working whois installation. 
    - Create a LOCAL database, and a WHOIS_MIRROR_RIPE_GRS database, and create tables in both using the whois_schema.sql script.
   ...
   ``` 
    ...
    - If the query is successful, we can proceed with [Setup automatic updating with NRTMv3](#section-ripe-database-mirror-02-near-real-time-mirroring-v3--near-real-time-Mirroring-v3).
...
3. Using [IRRd](https://github.com/irrdnet/irrd) with [NRTMv4](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--near-real-time-Mirroring-v4). 
   ...
   *This feature is in development and is subject to change.*
   ...
   using [Snapshot Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file) and [Delta Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file). By following these protocols, mirror clients ensure accurate and 
   ...
   - **Configure IRRd for NRTMv4**: Modify your IRRd configuration to enable support for NRTMv4. This typically 
     involves configuring the URLs for [Snapshot Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file), [Delta Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file), and the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file). 
   ...
   - **Querying Data**: Use the IRRd command-line tools or APIs to query data from the NRTMv4 database. For example:
     ...
     - Fetch and view the [Snapshot Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file) and [Delta Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file) to understand the current state and changes in the 
       database.
   - **Update Notifications**: Monitor the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file) and [Delta Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file) to stay updated with 
     changes in the database. Configure IRRd to regularly publish these files according to the [NRTMv4 specifications](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--near-real-time-mirroring-v4).
   - **Handling Updates**: Process [Delta Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file) to apply incremental updates to your local instance of IRRd, 
...
<div id="section-ripe-database-mirror-02-near-real-time-mirroring-v3" class="section-title">02 Near Real Time Mirroring v3</div>

<a id="section-ripe-database-mirror-02-near-real-time-mirroring-v3--near-real-time-mirroring-v3"></a>
...
<a id="section-ripe-database-mirror-02-near-real-time-mirroring-v3--pre-conditions"></a>
## Pre-conditions:

* You have a working installation of whois. Check the [installation instructions](#section-installation-and-development-06-installation-instructions--installation-instructions).
* You have already imported an export from the RIPE Database using Setup a [RIPE GRS mirror using Bootstrap and NRTM](#section-ripe-database-mirror-01-setup-ripe-database-mirror--setup-ripe-database-mirror).
* You have kept the RIPE.CURRENTSERIAL that corresponds to the snapshot you downloaded.

<a id="section-ripe-database-mirror-02-near-real-time-mirroring-v3--steps"></a>
## Steps
...
<a id="section-ripe-database-mirror-02-near-real-time-mirroring-v3--nrtm-and-keepalive"></a>
## NRTM and Keepalive
...
<a id="section-ripe-database-mirror-02-near-real-time-mirroring-v3--how-to-access-the-nrtm-stream"></a>
## How to access the NRTM stream

You will find all technical requirements to access the stream and more information about NRTM [in this document](#section-ripe-database-mirror-04-access-to-nrtm--access-to-nrtm).


<a id="section-ripe-database-mirror-02-near-real-time-mirroring-v3--legal-framework"></a>
## Legal Framework
...
<a id="section-ripe-database-mirror-02-near-real-time-mirroring-v3--transferring-to-a-third-party"></a>
...
<a id="section-ripe-database-mirror-02-near-real-time-mirroring-v3--contact"></a>
## Contact
...
<div id="section-ripe-database-mirror-03-near-real-time-mirroring-v4" class="section-title">03 Near Real Time Mirroring v4</div>

<a id="section-ripe-database-mirror-03-near-real-time-mirroring-v4--near-real-time-mirroring-v4"></a>
...
endpoint, using periodic [Snapshots Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file) and regular [Delta Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file). It includes integrity checks through 
...
<a id="section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-initialization"></a>
## Snapshot Initialization

We initialise the [Snapshot](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file) during the first export for the Database or if there is a history lost and cannot 
produce continuous [deltas](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file). The server notifies to the user when this happens, to ensure that the client 
...
2. A new [Snapshot](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file) is generated for version one, this [Snapshot](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file) may be empty if the database is empty.
3. A new [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file) is generated with the same session ID created in the first step. The session 
   ID is referencing the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file) with the [Snapshot](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file). This first snapshot doesn't have any 
   [Delta](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file).
4. We update the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file) with the new contents.
...
<a id="section-ripe-database-mirror-03-near-real-time-mirroring-v4--publishing-updates"></a>
## Publishing updates

<a id="section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file"></a>
...
- Information on the [Snapshot File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file) and [Delta Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file).
...
7. `version`: represents the latest version number, aligning with the highest version of the included snapshot and 
   deltas.
8. `snapshot`: contains the details of the [Snapshot File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file), including the version, URL foe retrieval, and SHA-256 
   hash for integrity verification.
9. `deltas`: List all [Delta Files](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file) with their respective version numbers, URLs, and hashes ensuring sequential 
...
<a id="section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file"></a>
### Snapshot File
...
To avoid issues where a client retrieves an [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file) just before it is 
updated, servers should retain old Snapshot Files for at least 5 minutes after a new [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file) is published. This allows
...
3. `version`: must be an unsigned positive integer and match the `version` field in the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file).
4. `type`: must be "snapshot".
5. `source`: must match the `source` field in the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file).
6. `session_id`: must match the `session_id` in the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file).
...
<a id="section-ripe-database-mirror-03-near-real-time-mirroring-v4--delta-file"></a>
### Delta File

Delta files are used for keeping track of the changes done to the Database. The delta file is always compared with the 
previous delta file, so there will never be a version 1. The first delta will be compared with the [initialized snapshot](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--snapshot-file) 
...
6. [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file) will include the new Delta File and the updated database version.
7. Must match the `session_id` of the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file).
8. Must match the `source` of the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file).
...
<a id="section-ripe-database-mirror-03-near-real-time-mirroring-v4--key-configuration"></a>
## Key Configuration

To enable NRTMv4 we generate and configure a private Ed25519 key and provide the corresponding public key, the IRR
Database name, and the publication URL of the [Update Notification File](#section-ripe-database-mirror-03-near-real-time-mirroring-v4--update-notification-file). The public key is base64 encoded.
...
<a id="section-ripe-database-mirror-03-near-real-time-mirroring-v4--key-rotation"></a>
### Key Rotation
...
<div id="section-ripe-database-mirror-04-access-to-nrtm" class="section-title">04 Access to NRTM</div>

<a id="section-ripe-database-mirror-04-access-to-nrtm--access-to-nrtm"></a>
# Access to NRTM

<a id="section-ripe-database-mirror-04-access-to-nrtm--abstract"></a>
## Abstract

This document describes show to access a RIPE Near Real Time Mirror (NRTM) Database data stream from the RIPE NCC.


<a id="section-ripe-database-mirror-04-access-to-nrtm--introduction"></a>
## Introduction
...
<a id="section-ripe-database-mirror-04-access-to-nrtm--nrtm-protocols"></a>
## NRTM Protocols
...
<a id="section-ripe-database-mirror-04-access-to-nrtm--excluded-data"></a>
## Excluded Data
...
<a id="section-ripe-database-mirror-04-access-to-nrtm--initial-setup"></a>
## Initial Setup
...
<a id="section-ripe-database-mirror-04-access-to-nrtm--accessing-the-data-stream"></a>
...
A client can use the `-q sources` flag with the mirror server to retrieve information regarding available mirroring possibilities. Please see [this section](#section-types-of-queries-13-ripe-ncc-global-resource-service--ripe-ncc-global-resource-service) for more details.
...
<div id="section-installation-and-development-01-getting-started-on-macos" class="section-title">01 Getting started on macOS</div>

<a id="section-installation-and-development-01-getting-started-on-macos--getting-started-on-macos"></a>
# Getting Started on macOS
It is recommended to use [Brew](http://brew.sh) for quick installation of required binaries.

<a id="section-installation-and-development-01-getting-started-on-macos--java"></a>
## Java
<a id="section-installation-and-development-01-getting-started-on-macos--installation"></a>
### Installation
Install OpenJDK 17 or higher.

<a id="section-installation-and-development-01-getting-started-on-macos--using-brewhttpbrewsh"></a>
#### Using [Brew](http://brew.sh)
* Run `brew install openjdk`

<a id="section-installation-and-development-01-getting-started-on-macos--manually"></a>
#### Manually
...
<a id="section-installation-and-development-01-getting-started-on-macos--multiple-java-versions"></a>
...
<a id="section-installation-and-development-01-getting-started-on-macos--maven"></a>
## Maven
Maven can be installed through [Brew](http://brew.sh): run `brew install maven`

<a id="section-installation-and-development-01-getting-started-on-macos--git"></a>
## Git
...
<a id="section-installation-and-development-01-getting-started-on-macos--git-bash-completion-optional"></a>
...
<a id="section-installation-and-development-01-getting-started-on-macos--mariadb"></a>
## MariaDB
...
<a id="section-installation-and-development-01-getting-started-on-macos--configuration"></a>
### Configuration
[Configure MariaDB](#section-installation-and-development-04-configure-mariadb--configure-mariadb)
...
<div id="section-installation-and-development-02-getting-started-on-ubuntu-linux" class="section-title">02 Getting started on Ubuntu Linux</div>

<a id="section-installation-and-development-02-getting-started-on-ubuntu-linux--getting-started-on-ubuntu-linux"></a>
# Getting started on Ubuntu Linux

<a id="section-installation-and-development-02-getting-started-on-ubuntu-linux--install-packages"></a>
## Install packages
...
<a id="section-installation-and-development-02-getting-started-on-ubuntu-linux--configure-mariadb"></a>
## Configure MariaDB

[Configure MariaDB](#section-installation-and-development-04-configure-mariadb--configure-mariadb)

<a id="section-installation-and-development-02-getting-started-on-ubuntu-linux--system"></a>
## System
...
<div id="section-installation-and-development-03-building-whois" class="section-title">03 Building whois</div>

<a id="section-installation-and-development-03-building-whois--building-whois"></a>
# Building whois
...
<a id="section-installation-and-development-03-building-whois--goals"></a>
## Goals
...
<a id="section-installation-and-development-03-building-whois--release"></a>
## Release
...
<a id="section-installation-and-development-03-building-whois--configuring-your-ide"></a>
...
<a id="section-installation-and-development-03-building-whois--running-whois-from-within-intellij"></a>
### Running whois from within Intellij

- Ensure MariaDB and the needed databases are created and populated
  - See [Getting Started on macOS](#section-installation-and-development-01-getting-started-on-macos--getting-started-on-macos) for installation information.
  - See [Configure MariaDB](#section-installation-and-development-04-configure-mariadb--configure-mariadb) for instructions how to create and grant user permission.
  - See [Installation instructions](#section-installation-and-development-06-installation-instructions--installation-instructions) for instructions on how to create and populate needed databases.
...
<a id="section-installation-and-development-03-building-whois--importing-multiple-maven-sub-projects-under-one-project"></a>
...
<a id="section-installation-and-development-03-building-whois--upgrading-intellij"></a>
### Upgrading IntelliJ
...
<a id="section-installation-and-development-03-building-whois--suggested-intellij-ide-preferences"></a>
...
<div id="section-installation-and-development-04-configure-mariadb" class="section-title">04 Configure MariaDB</div>

<a id="section-installation-and-development-04-configure-mariadb--configure-mariadb"></a>
# Configure MariaDB

Installing a MariaDB server is useful for development, or for running your own Whois server.

<a id="section-installation-and-development-04-configure-mariadb--configuration"></a>
## Configuration
...
<a id="section-installation-and-development-04-configure-mariadb--development-machine"></a>
### Development machine
...
<a id="section-installation-and-development-04-configure-mariadb--running-your-own-whois-server"></a>
...
<a id="section-installation-and-development-04-configure-mariadb--configure-access-to-the-database"></a>
...
<div id="section-installation-and-development-05-coding-standard" class="section-title">05 Coding standard</div>

<a id="section-installation-and-development-05-coding-standard--coding-standard"></a>
# Coding standard
...
<a id="section-installation-and-development-05-coding-standard--code-format"></a>
### Code Format
...
<a id="section-installation-and-development-05-coding-standard--java-conventions"></a>
### Java Conventions
...
<a id="section-installation-and-development-05-coding-standard--commits"></a>
### Commits
...
<a id="section-installation-and-development-05-coding-standard--file-naming-conventions"></a>
...
<a id="section-installation-and-development-05-coding-standard--testing"></a>
### Testing
* Use Hamcrest assertions (ie assertThat(..., is(..)) instead of assertEquals(..,..))

<a id="section-installation-and-development-05-coding-standard--intellij-editor-settings"></a>
...
<a id="section-installation-and-development-05-coding-standard--git"></a>
### Git
...
<div id="section-installation-and-development-06-installation-instructions" class="section-title">06 Installation instructions</div>

<a id="section-installation-and-development-06-installation-instructions--installation-instructions"></a>
# Installation instructions

In this section we show how to make a standard setup of whois.

<a id="section-installation-and-development-06-installation-instructions--prerequisite"></a>
## Prerequisite 
...
<a id="section-installation-and-development-06-installation-instructions--requirements"></a>
## Requirements
...
<a id="section-installation-and-development-06-installation-instructions--setup"></a>
## Setup
* Create a "fat"/shaded jar using `mvn clean install -Prelease`. If you have issues, check the [build page](#section-installation-and-development-03-building-whois--building-whois).
...
<a id="section-installation-and-development-06-installation-instructions--load-local-whois-with-initial-test-content"></a>
...
You can check the instructions in [WHOIS-REST-API](#section-update-methods-01-restful-api--ripe-database-restful-api) for more info about the REST API


<a id="section-installation-and-development-06-installation-instructions--how-to-allow-unlimited-queries"></a>
## How to allow unlimited queries

The Whois server can block a client's IP as explained [here](#section-types-of-queries-12-access-control-for-queries--access-control-for-queries).
...
<a id="section-installation-and-development-06-installation-instructions--how-to-enable-full-text-search-queries"></a>
## How to enable Full-Text Search queries

The Whois server supports text searches [full text search](#section-how-to-query-the-ripe-database-02-web-query-form--using-full-text-search).
...
<div id="section-database-support-01-support-overview" class="section-title">01 Support Overview</div>

<a id="section-database-support-01-support-overview--support-overview"></a>
# Support Overview
<a id="section-database-support-01-support-overview--user-manuals"></a>
## User Manuals

* [RIPE Database Document Library](#section-introduction-to-the-ripe-database-01-ripe-database-documentation-overview--ripe-database-documentation-overview)
Manuals and reference material for new and experienced user of the RIPE Database
* [Organisation Object in the RIPE Database](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-organisation-object)
About the **organisation** Object


<a id="section-database-support-01-support-overview--security"></a>
## Security

* [Protecting your data in the RIPE Database](#section-authorisation-01-authorisation-model--authorisation-model)
Various **security methods** available to RIPE Database users
* [Using PGP with the RIPE Database](#section-authorisation-02-using-the-authorisation-methods--pgp-key)
Several links to documents explaining how to use **PGP for authentication**
* [IRT Object - Technical How To Guide](#section-authorisation-13-irt-object--irt-object)
How to handle the **Incident Response Team(IRT) object** in the RIPE Database


<a id="section-database-support-01-support-overview--operational"></a>
## Operational

* [Clean-up of Unreferenced Data - Detailed explanation with examples](#section-database-support-02-clean-up-of-unreferenced-data--clean-up-of-unreferenced-data)
Database cleanup process described in detail with examples of data subject to deletion.
* [Near Real Time Mirroring v3](#section-ripe-database-mirror-02-near-real-time-mirroring-v3--near-real-time-Mirroring-v3)
...
<div id="section-database-support-02-clean-up-of-unreferenced-data" class="section-title">02 Clean up of Unreferenced Data</div>

<a id="section-database-support-02-clean-up-of-unreferenced-data--clean-up-of-unreferenced-data"></a>
# Clean-up of Unreferenced Data
<a id="section-database-support-02-clean-up-of-unreferenced-data--introduction"></a>
## Introduction
...
<a id="section-database-support-02-clean-up-of-unreferenced-data--authority"></a>
## Authority
...
<a id="section-database-support-02-clean-up-of-unreferenced-data--process"></a>
## Process
...
<div id="section-database-support-03-database-security" class="section-title">03 Database Security</div>

<a id="section-database-support-03-database-security--ripe-database-security"></a>
# RIPE Database Security

**A collection of documents designed to help with security of whois data stored in the RIPE Database**

* [Recommendations for protecting your data in the RIPE Database](#section-authorisation-01-authorisation-model--authorisation-model)
This page provides best practices and recommendations for protecting your objects in the RIPE Database.

* [Security and the RIPE Database](#section-authorisation-02-using-the-authorisation-methods--using-the-authorisation-methods)
...
* [IRT Object - Frequently Asked Questions](#section-authorisation-13-irt-object--irt-object)
Help with the Incident Response Team (IRT) object in the RIPE Database


<a id="section-database-support-03-database-security--maintainers"></a>
## Maintainers
...
<a id="section-database-support-03-database-security--the-default-maintainer"></a>
...
<a id="section-database-support-03-database-security--personal-maintainers-versus-shared-maintainers"></a>
...
<div id="section-database-support-04-configuring-reverse-dns" class="section-title">04 Configuring Reverse DNS</div>

<a id="section-database-support-04-configuring-reverse-dns--configuring-reverse-dns"></a>
...
<a id="section-database-support-04-configuring-reverse-dns--reverse-dns-overview"></a>
...
<a id="section-database-support-04-configuring-reverse-dns--mapping-ip-addresses-into-the-dns-name-hierarchy"></a>
...
<a id="section-database-support-04-configuring-reverse-dns--dealing-with-multiple-zones-for-one-address-block"></a>
...
<a id="section-database-support-04-configuring-reverse-dns--step-3a-create-your-domain-objects-using-webupdates"></a>
...
<a id="section-database-support-04-configuring-reverse-dns--step-3b-create-your-domain-objects-using-syncupdates-email-or-the-api"></a>
...
<a id="section-database-support-04-configuring-reverse-dns--requesting-dnssec-delegations"></a>
...
When we receive a **domain** object with DNSSEC-related information, we will carry out [additional tests](#section-authorisation-16-request-dnssec-delegation--delegation-checks).


<a id="section-database-support-04-configuring-reverse-dns--automated-update-of-dnssec-delegations"></a>
...
<a id="section-database-support-04-configuring-reverse-dns--reverse-dns-troubleshooting"></a>
...
<div id="section-database-support-05-database-business-rules" class="section-title">05 Database Business Rules</div>

<a id="section-database-support-05-database-business-rules--database-business-rules"></a>
...
<div id="section-database-support-06-highlighted-values-in-the-ripe-database" class="section-title">06 Highlighted Values in the RIPE Database</div>

<a id="section-database-support-06-highlighted-values-in-the-ripe-database--highlighted-values-in-the-ripe-database"></a>
...
<a id="section-database-support-06-highlighted-values-in-the-ripe-database--non-highlighted-values"></a>
...
<a id="section-database-support-06-highlighted-values-in-the-ripe-database--data-not-published-in-the-ripe-database"></a>
...
<div id="section-database-support-07-create-first-role-mntner" class="section-title">07 Create First Role Mntner</div>

<a id="section-database-support-07-create-first-role-mntner--create-the-first-role-and-mntner-objects"></a>
# Create the First ROLE and MNTNER Objects

<a id="section-database-support-07-create-first-role-mntner--what-is-a-role-object"></a>
...
<a id="section-database-support-07-create-first-role-mntner--what-is-a-nic-handle"></a>
...
<a id="section-database-support-07-create-first-role-mntner--what-is-a-mntner-pronounced-maintainer"></a>
...
Personal Contact Details are held in several object types ([see Appendix G](#section-appendices-07-appendix-g--object-types-with-personal-data--appendix-g-object-types-with-personal-data)) 
...
objects may be involved ([see Appendix G](#section-appendices-07-appendix-g--object-types-with-personal-data--appendix-g-object-types-with-personal-data)).
...
If an object needs to be deleted, special considerations may apply, depending on the object type ([see Appendix F](#section-appendices-06-appendix-f--special-considerations-for-object-types--appendix-f-special-considerations-for-object-types)).
...
Refer to [protection of route object space](#section-authorisation-07-protection-of-route-object-space--protection-of-route-6-object-space).
...
For more information, refer to [Access to NRTM](#section-ripe-database-mirror-04-access-to-nrtm--abstract).
...
<div id="section-appendices-01-appendix-a--syntax-of-object-attributes" class="section-title">01 Appendix A  Syntax of Object Attributes</div>

<a id="section-appendices-01-appendix-a--syntax-of-object-attributes--appendix-a--syntax-of-object-attributes"></a>
...
Defines an authorisation scheme to be used. For a description, see the section, ['Authorisation Model'](#section-authorisation-01-authorisation-model--authorisation-model)  
...
Specifies the type of the organisation. The possible values are shown in the section ['Description of the ORGANIZATION Object'](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-organisation-object)'.
...
**status:** &lt;status&gt;  
Specifies the status of the address range represented by an **inetnum** or **inet6num** object or the status of an AS Number represented by an **aut-num** object. For the possible values, see the sections ['Description of the INETNUM Object'](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-inetnum-object), ['Description of the INET6NUM Object'](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-inet6num-object) and ['Description of the AUT-NUM Object'](#section-rpsl-object-types-02-descriptions-of-primary-objects--description-of-the-aut-num-object).
...
<div id="section-appendices-02-appendix-b--copyright-statement" class="section-title">02 Appendix B  Copyright Statement</div>

<a id="section-appendices-02-appendix-b--copyright-statement--appendix-b--copyright-statement"></a>
...
<div id="section-appendices-03-appendix-c--ripe-database-query-server-response-codes-and-messages" class="section-title">03 Appendix C  RIPE Database Query Server Response Codes and Messages</div>

<a id="section-appendices-03-appendix-c--ripe-database-query-server-response-codes-and-messages--appendix-c--ripe-database-query-server-response-codes-and-messages"></a>
...
<a id="section-appendices-03-appendix-c--ripe-database-query-server-response-codes-and-messages--query-errors"></a>
## Query Errors
...
<a id="section-appendices-03-appendix-c--ripe-database-query-server-response-codes-and-messages--access-errors"></a>
## Access Errors
...
Limit of returned objects has been reached. The connection is terminated. Continued attempts to excessively query the database will result in permanent denial of service. See section [Access Control for Queries](#section-types-of-queries-12-access-control-for-queries--access-control-for-queries) for more information.

**%ERROR:203: address passing not allowed** 
The host is not registered as a proxy and is not allowed to pass addresses on the query line (`-V` ag). See section [Access Control for Queries](#section-types-of-queries-12-access-control-for-queries--access-control-for-queries) for more information.


<a id="section-appendices-03-appendix-c--ripe-database-query-server-response-codes-and-messages--connection-errors"></a>
## Connection Errors
...
<a id="section-appendices-03-appendix-c--ripe-database-query-server-response-codes-and-messages--nrtm-errors"></a>
## NRTM Errors
...
<a id="section-appendices-03-appendix-c--ripe-database-query-server-response-codes-and-messages--warnings"></a>
## Warnings
...
<div id="section-appendices-04-appendix-d--route-object-creation-flowchart" class="section-title">Appendix-D--Route-Object-Creation-Flowchart</div>
...
<a id="section-appendices-04-appendix-d--route-object-creation-flowchart--route-object-creation-flowchart"></a>
...
<div id="section-appendices-05-appendix-e--domain-object-creation-flowchart" class="section-title">Appendix-E--Domain-Object-Creation-Flowchart</div>
...
<a id="section-appendices-05-appendix-e--domain-object-creation-flowchart--domain-object-creation-flowchart"></a>
...
<div id="section-appendices-06-appendix-f--special-considerations-for-object-types" class="section-title">06 Appendix F  Special Considerations for Object Types</div>

<a id="section-appendices-06-appendix-f--special-considerations-for-object-types--appendix-f--special-considerations-for-object-types"></a>
...
<div id="section-appendices-07-appendix-g--object-types-with-personal-data" class="section-title">07 Appendix G  Object Types with Personal Data</div>

<a id="section-appendices-07-appendix-g--object-types-with-personal-data--appendix-g--object-types-with-personal-data"></a>
...
<div id="section-appendices-08-appendix-h--pgp-authentication-method" class="section-title">08 Appendix H  PGP Authentication Method</div>

<a id="section-appendices-08-appendix-h--pgp-authentication-method--appendix-h--pgp-authentication-method"></a>
...
beginning, supposing that there is no a previous [mntner object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-mntner-object)
created.
* [Create the first mntner and role object](#section-database-support-07-create-first-role-mntner--what-is-a-role-object).
...
```
* Now is time to create the [key-cert object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-key-cert-object). 
...
* Once the [key-cert object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-key-cert-object) 
is created you need to update your previous [mntner object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-mntner-object) 
adding a new "auth:" attribute pointing to the created key-cert.
* Finally, now that the [key-cert object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-key-cert-object) 
is created and associated with the mntner. The last step is to perform an update authenticated with the key-cert 
  object. In this example [syncupdates](#section-update-methods-03-syncupdates--syncupdates) is 
  used for it.
...
[key-cert object](#section-rpsl-object-types-03-descriptions-of-secondary-objects--description-of-the-key-cert-object).
...
<div id="section-appendices-09-appendix-i--client-certificate-authentication" class="section-title">09 Appendix I  Client Certificate Authentication</div>

<a id="section-appendices-09-appendix-i--client-certificate-authentication--appendix-i--client-certificate-authentication"></a>
# Appendix I- Client Certificate Authentication

<a id="section-appendices-09-appendix-i--client-certificate-authentication--introduction"></a>
## Introduction
...
<a id="section-appendices-09-appendix-i--client-certificate-authentication--generate-a-self-signed-certificate"></a>
...
<a id="section-appendices-09-appendix-i--client-certificate-authentication--convert-certificate-to-ascii"></a>
...
<a id="section-appendices-09-appendix-i--client-certificate-authentication--create-key-cert-object"></a>
...
<a id="section-appendices-09-appendix-i--client-certificate-authentication--add-authentication-method-to-maintainer"></a>
...
<a id="section-appendices-09-appendix-i--client-certificate-authentication--lookup-an-object"></a>
### Lookup An Object
...
<a id="section-appendices-09-appendix-i--client-certificate-authentication--update-an-object"></a>
### Update An Object
...
<div id="section-appendices-10-appendix-j--ripe-test-database" class="section-title">10 Appendix J  Ripe Test Database</div>

<a id="section-appendices-10-appendix-j--ripe-test-database--appendix-j--ripe-test-database"></a>
# Appendix J- Ripe Test Database

<a id="section-appendices-10-appendix-j--ripe-test-database--introduction"></a>
## Introduction
...
<a id="section-appendices-10-appendix-j--ripe-test-database--creating-objects-in-the-test-database"></a>
...
<a id="section-appendices-10-appendix-j--ripe-test-database--finding-objects-in-the-test-database"></a>
...
<a id="section-appendices-10-appendix-j--ripe-test-database--mntner-objects-in-the-test-database"></a>
...
<a id="section-appendices-10-appendix-j--ripe-test-database--creating-inetnum-allocations-in-the-test-database"></a>
...
<a id="section-appendices-10-appendix-j--ripe-test-database--creating-aut-num-objects-in-the-test-database"></a>
...
<a id="section-appendices-10-appendix-j--ripe-test-database--creating-route-objects"></a>
...
<div id="section-appendices-11-appendix-k--api-keys" class="section-title">11 Appendix K  API Keys</div>

<a id="section-appendices-11-appendix-k--api-keys--appendix-k--api-keys"></a>
# Appendix K- API Keys
...
<a id="section-appendices-11-appendix-k--api-keys--introduction"></a>
## Introduction
...
<a id="section-appendices-11-appendix-k--api-keys--create-a-new-database-key"></a>
...
<a id="section-appendices-11-appendix-k--api-keys--list-database-keys"></a>
## List Database Keys
...
<a id="section-appendices-11-appendix-k--api-keys--authenticated-queries-using-an-api-key"></a>
...
```
<a id="section-appendices-11-appendix-k--api-keys--authenticated-updates-using-an-api-key"></a>
...
<a id="section-appendices-11-appendix-k--api-keys--revoking-an-api-key"></a>
## Revoking an API Key
