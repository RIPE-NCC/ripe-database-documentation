...
### Domain Name System Security Externsions (DNSSEC)
The Domain Name System Security Externsions (DNSSEC) is a suite of Internet Engineering Task Force (IETF) specifications for security certain kinds of information provided by the Domain Name System (DNS) as used on Internet Protocol (IP) networks. It is a set of extensions to DNS which provide to DNS clients (resolvers) origin authentication of DNS data, authenticated denial of existence, and data integrity, but not availablity or confidentiality.
...
### UTF8
A character encoding capable of encoding all posssible characters.
