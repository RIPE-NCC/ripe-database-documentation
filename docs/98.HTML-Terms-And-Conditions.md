...
1. The RIPE Database contains information for the following purposes:
...
1. The RIPE NCC shall announce any planned maintenance of the RIPE Database as well as any confirmed incidents related to the operation of the RIPE Database on the RIPE NCC status page.
1. The Registrant or the Maintainer may report any identified incident via the 24/7 Technical Emergency Hotline.
1. The Registrant or the Maintainer may address security questions relating to the RIPE Database to security@ripe.net.
1. The RIPE NCC shall publish information about the security policies and measures in relation to the RIPE NCC services in the RIPE NCC Trust Portal.
1. The RIPE NCC may perform security checks and/or audits to the RIPE Database. The RIPE NCC may share any available report of such checks and/or audits upon request by the Registrant or the Maintainer and subject to a non-disclosure agreement.
...
1. The RIPE NCC may engage with third parties for the provision of RIPE NCC services. Information about such third parties (subcontractors) is available in the [RIPE NCC Trust Portal](https://trust.ripe.net/legal-compliance/).
1. The RIPE NCC shall publish information about service levels of RIPE NCC services on the [RIPE NCC status page](https://status.ripe.net/).
1. The RIPE NCC shall publish information regarding the integrity, privacy and confidentiality of the data it processes in the [RIPE NCC Trust Portal](https://trust.ripe.net/legal-compliance/). 
