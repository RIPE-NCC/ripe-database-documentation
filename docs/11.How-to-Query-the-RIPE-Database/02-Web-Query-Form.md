...
Personal data may be returned by the Full Text search API. You may be blocked if excessive amounts of personal data is returned. For more information refer to [blocking access section](../Access-to-Personal-Data/README/#blocking-access-to-the-ripe-database)
