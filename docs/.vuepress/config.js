...
module.exports = {
  ...
  referencesInsidePageFormatter: function (current){
    ...
    return current.content.replace(regex, function(matchingWord,firstMatchingPart,secondMatchingPart,thirdMatchingPart){  
      ...
      if(secondMatchingPart.startsWith("](../Legal-Information.md") || secondMatchingPart.startsWith("](Legal-Information.md")){ 
  ...
  referencesOtherPageFormatter: function (current){
    ...
    return current.content.replace(regex, function(matchingWord,firstMatchingPart,secondMatchingPart,thirdMatchingPart){   
      ...
      if(secondMatchingPart.startsWith("](../RIPE-Database-Acceptable-Use-Policy.md") || secondMatchingPart.startsWith("](RIPE-Database-Acceptable-Use-Policy.md")){
    ...
    [
      'vuepress-plugin-merge-pages',
      {
        ...
        },
        {
          ...
          filter: (pages) => {
            return pages.filter(({ path }) => path.includes('25.HTML-Terms-And-Conditions'))
          }, 
          mergePages: pages => {
            const pageBreak = '<hr class="page-break" />\n\n'
            return pages
  ...
  function: { 
    referencesFormatter(matchingWord,firstMatchingPart,secondMatchingPart,thirdMatchingPart){
      if(secondMatchingPart.startsWith("](../Legal-Information.md") || secondMatchingPart.startsWith("](Legal-Information.md")){ //legal information is generated by TD, it doesn't has third part so we need to modify entire reference
        return firstMatchingPart+ '](' + "#ripe-database-terms-and-conditions"+ ')';
      }
      if(secondMatchingPart.startsWith("](http") || secondMatchingPart.startsWith("](https")){ //dont change absolute links
        return matchingWord;
