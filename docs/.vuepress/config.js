...
module.exports = {
  ...
  themeConfig: {
    nav: [],
    sidebar: sidebar.filter(s => s !== '23.HTML-Terms-And-Conditions'),
  ...
  function: { 
    referencesFormatter(matchingWord,firstMatchingPart,secondMatchingPart,thirdMatchingPart){
      if(secondMatchingPart.startsWith("](../23.Legal-Information.md") || secondMatchingPart.startsWith("](23.Legal-Information.md")){ //legal information is generated by TD, it doesn't has third part so we need to modify entire reference
        return firstMatchingPart+ '](' + "#ripe-database-terms-and-conditions"+ ')';
      }
      if(secondMatchingPart.startsWith("](http") || secondMatchingPart.startsWith("](https")){ //dont change absolute links
        return matchingWord;
