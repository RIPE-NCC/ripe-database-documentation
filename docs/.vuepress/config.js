            ...
            return pages
              .reduce((acc, current) => {
                const contentWithCorrectLinks = current.content.replace(regex, function(matchingWord,firstMatchingPart,secondMatchingPart,thirdMatchingPart){
                  if(secondMatchingPart.startsWith("](../23.Legal-Information.md")){ //legal information is generated by TD, it doesn't has third part so we need to modify entire reference
