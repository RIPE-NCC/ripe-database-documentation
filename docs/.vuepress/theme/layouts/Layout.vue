    ...
    <Sidebar :items="sidebarItems" @toggle-sidebar="toggleSidebar">
      ...
      <template #bottom>
        ...
        <ul class="sidebar-links">
          <li><a href="/terms-conditions" aria-current="page" class="sidebar-link">Terms and Conditions</a></li>
          <li><a href="/acceptable-use-policy" aria-current="page" class="sidebar-link">Acceptable Use Policy</a></li>
          <li><a href="/entire-documentation-HTML" aria-current="page" class="sidebar-link">Entire Documentation HTML</a></li>
        </ul>
      </template>
    </Sidebar>
