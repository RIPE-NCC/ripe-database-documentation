  ...
  >
    ...
    <Sidebar :items="sidebarItems" @toggle-sidebar="toggleSidebar">
      ...
      <template #bottom>
        ...
        <ul class="sidebar-links"><li><a href="/docs/entire-documentation" aria-current="page" class="sidebar-link">Autogenerated documentation</a></li></ul>
      </template>
    </Sidebar>
    ...
    <component is="noscript" v-if="$page.frontmatter.navbar !== false">
      <meta http-equiv="refresh" content="0; url='/docs/entire-documentation'" />
    </component>
