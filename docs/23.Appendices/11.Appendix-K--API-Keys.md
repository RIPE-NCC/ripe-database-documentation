...
* Specify the key type - This section only covers Maintainer-type APIKEYs. For more overview of the available key 
  types and their use cases, see [Extending API Keys Beyond the RIPE Database](https://labs.ripe.net/author/fallon-albrecht/extending-api-keys-beyond-the-ripe-database/)
