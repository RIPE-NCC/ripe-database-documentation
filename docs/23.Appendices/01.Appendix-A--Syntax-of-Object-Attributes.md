...
Identifies a country. &lt;country-code&gt; Officially Assigned two-letter ISO 3166 country code or "EU" (exceptionally reserved).
...
**upd-to:** &lt;e-mail&gt;  
Specifies the email address to be notified when an object protected by a **mntner** is unsuccessfully updated. See also the section, ['Notifications'](../Notifications/Notifications/#notifications)'.
