...
For set objects with non-hierarchical names, authorisation corresponds to the rules for individual objects described in the section ['Security of Data Using Authorisation'](Security-of-Data-Using-Authorisation/#security-of-data-using-authorisation).
