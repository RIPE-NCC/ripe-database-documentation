...
Some attributes allow the value to be a list. This must be a comma-separated list with no spaces allowed. These attributes can be viewed in the [Appendix](../18.Appendices/01-Appendix-A--Syntax-of-Object-Attributes.md#appendix-a-syntax-of-object-attributes).
