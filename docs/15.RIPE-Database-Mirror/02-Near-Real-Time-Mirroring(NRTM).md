...
The RIPE NCC NRTM Service and its use is regulated bu the [RIPE Database Terms and Conditions](https://apps.db.ripe.net/db-web-ui/legal#terms-and-conditions) and [RIPE Database Acceptable Use Policy](../23.RIPE-Database-Acceptable-Use-Policy.md#ripe-database-acceptable-use-policy).
...
* The user ensures that third party accepts the [RIPE Database Terms and Conditions](https://apps.db.ripe.net/db-web-ui/legal#terms-and-conditions) for this purpose.
