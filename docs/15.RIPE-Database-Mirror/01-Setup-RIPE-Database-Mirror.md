...
3. Using [IRRdv4](https://github.com/irrdnet/irrd) with [NRTMv4](../RIPE-Database-Mirror/Near-Real-Time-Mirroring-v4/#near-real-time-Mirroring-v4). 

   *This feature is still in progress. We recommend using another mirroring setup for now.*
