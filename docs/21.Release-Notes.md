...
* [RIPE Database Release 1.124](#ripe-database-release-1-124)

**Current Release**

* [RIPE Database Release 1.123](#ripe-database-release-1-123)

**Previous Releases**

* [RIPE Database Release 1.122.1](#ripe-database-release-1-122-1)
* [RIPE Database Release 1.122](#ripe-database-release-1-122)
* [RIPE Database Release 1.121.2](#ripe-database-release-1-121-2)
* [RIPE Database Release 1.121.1](#ripe-database-release-1-121-1)
* [RIPE Database Release 1.121](#ripe-database-release-1-121)
* [RIPE Database Release 1.120](#ripe-database-release-1-120)
* [RIPE Database Release 1.119](#ripe-database-release-1-119)
...
* For each **mntner** object in the Release Candidate database, all auth: attributes have been removed.
...
mnt-by: ninja-mnt
...
can be changed in the web application by choosing the ninja-mnt maintainer from a popup on the modify object page.
...
### New or Improved Features
Whois Release 1.116 includes the following changes:
...
### New or Improved Features
Whois Release 1.117 includes the following changes:
...
### New or Improved Features
Whois Release 1.118 includes the following changes:
...
## RIPE Database Release 1.119

### Date of Deployment
[Release Candidate (RC) environment](#release-candidate-environment): 17th September 2025
Production environment: 1st October 2025

### New or Improved Features
Whois Release 1.119 includes the following changes:
...
## RIPE Database Release 1.120

### Date of Deployment
[Release Candidate (RC) environment](#release-candidate-environment): 13th November 2025
Production environment: 27th November 2025

### New or Improved Features
Whois Release 1.120 includes the following changes:

* Whois scope is now mandatory for OAuth 2.0 tokens
* Added conditional attributes to object template (which depend on business rules)
* Add warning in update response if API key is expiring soon
* Redirect top-level IANA administrative blocks (i.e. top-level /8 allocations) to other RIRs in RDAP response
* Update RDAP geofeed implementation with changes in RFC 9877

## RIPE Database Release 1.121

### Date of Deployment
[Release Candidate (RC) environment](#release-candidate-environment): 18th February 2026
Production environment: 4th March 2026

### New or Improved Features
Whois Release 1.121 includes the following changes:

* Removed support for mntner and IRT passwords
...
## RIPE Database Release 1.121.1

### Date of Deployment
[Release Candidate (RC) environment](#release-candidate-environment): 16th March 2026
Production environment: 16th March 2026

### New or Improved Features
Whois Release 1.121.1 includes the following change:

* Fix for a cross-site vulnerability affecting the Syncupdates service.

The full list of changes can be found in the source repository:
  https://github.com/RIPE-NCC/whois/blob/master/changes.txt

## RIPE Database Release 1.121.2

### Date of Deployment
[Release Candidate (RC) environment](#release-candidate-environment): 18th March 2026
Production environment: 18th March 2026

### New or Improved Features
Whois Release 1.121.2 includes the following change:

* Prevent updates using Syncupdates GET method

The full list of changes can be found in the source repository:
  https://github.com/RIPE-NCC/whois/blob/master/changes.txt

## RIPE Database Release 1.122

### Date of Deployment
[Release Candidate (RC) environment](#release-candidate-environment): 16th April 2026
Production environment: 30th April 2026

### New or Improved Features
Whois Release 1.122 includes the following changes:

* Support UTF-8 in Free Text Attributes ("descr:" and "remarks:").
* NWI-20: Adjusting contact method requirements and adding new methods.
* Do not allow "mnt-lower:" on inetnum ASSIGNED PA
* Allow user to remove mnt-lower from ASSIGNED resources

The full list of changes can be found in the source repository:
  https://github.com/RIPE-NCC/whois/blob/master/changes.txt


## RIPE Database Release 1.122.1

### Date of Deployment
[Release Candidate (RC) environment](#release-candidate-environment): 
N/A

Production environment: 14th May 2026

### New or Improved Features
Whois Release 1.122.1 includes the following change:

* Add size limit to RDAP rirsearch1 queries

The full list of changes can be found in the source repository:
  https://github.com/RIPE-NCC/whois/blob/master/changes.txt


## RIPE Database Release 1.123

### Date of Deployment
[Release Candidate (RC) environment](#release-candidate-environment): 24th June 2026
Production environment: 8th July 2026

### New or Improved Features
Whois Release 1.123 includes the following changes:

* Fix version query encoding and support charset flag with version flags
* Improved resiliency to API keys backend failures and improved logging
* Normalise decomposed Unicode in descr: or remarks: attributes
* HTTP APIs use UTF-8 encoding by default
* RDAP Relation Search uses domains not domain element

The full list of changes can be found in the source repository:
[e93028c...d75e67c](https://github.com/RIPE-NCC/whois/compare/e93028c...d75e67c)


## RIPE Database Release 1.124

### Date of Deployment
[Release Candidate (RC) environment](#release-candidate-environment): 13th August 2026
Production environment: 27th August 2026

### New or Improved Features
Whois Release 1.124 includes the following changes:

* Added support for OIDC 2.0 authentication
* NRTMv3 server should skip invalid objects
* Do not unescape characters in UTF-8 substitution
* Added Content Security Policy (CSP) header
* Added HTTP Strict-Transport-Security (HSTS) header 
* Added text/plain responses to Versions API
* Added unformatted responses to Versions API

The full list of changes can be found in the source repository:
[c0593407...9095208c](https://github.com/RIPE-NCC/whois/compare/c0593407...9095208c)
