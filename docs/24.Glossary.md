...
### Pseudo-attribute
An attribute added to an object, or an update message, that is not part of the RPSL object structure. It is needed for the management of the object(s) in the update message. For example testing an update using the "dry-run:" pseudo attribute.
